...
function bookacti_create_tables() {
	...
	$table_notifications_query = 'CREATE TABLE ' . BOOKACTI_TABLE_NOTIFICATIONS . ' (
		id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
		object_type VARCHAR(128),
		target VARCHAR(128),
		`trigger` VARCHAR(128),
	...
	$table_notification_channels_query = 'CREATE TABLE ' . BOOKACTI_TABLE_NOTIFICATION_CHANNELS . ' (
		id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
	...
	dbDelta( 
	  ...
	  . $table_notifications_query
	  . $table_notification_channels_query
	);
}
...
function bookacti_drop_tables() {
	...
	$wpdb->query( 'DROP TABLE IF EXISTS ' . BOOKACTI_TABLE_NOTIFICATIONS . '; ' );
	$wpdb->query( 'DROP TABLE IF EXISTS ' . BOOKACTI_TABLE_NOTIFICATION_CHANNELS . '; ' );
}
