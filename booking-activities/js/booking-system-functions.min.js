...
"undefined"?e.message:bookacti_localized.error),console.log(e)},error:function(e){console.log("AJAX "+bookacti_localized.error);console.log(e)},complete:function(){bookacti_stop_loading_booking_system(b)}})}
...
function bookacti_fill_picked_events_list(b){var a=b.attr("id"),c=b.siblings(".bookacti-picked-events").find(".bookacti-picked-events-list-title"),f=b.siblings(".bookacti-picked-events").find(".bookacti-picked-events-list");f.empty();b.siblings(".bookacti-picked-events").hide();if(typeof bookacti.booking_system[a].picked_events!=="undefined"&&bookacti.booking_system[a].picked_events.length){var d=bookacti.booking_system[a].multiple_bookings;c.html(bookacti.booking_system[a].picked_events.length===
