...
$j("#bookacti-form-field-dialog-calendar").on("change","select#bookacti-activities",function(){bookacti_refresh_redirect_url_by_activity_table()}),$j("#bookacti-form-field-dialog-calendar").on("change","select#bookacti-group_categories",function(){bookacti_refresh_redirect_url_by_group_category_table()}),$j("#bookacti-form-field-dialog-calendar").on("change","select#bookacti-group_categories",function(){$j(this).val()==="none"?$j("#bookacti-groups_only-container, #bookacti-groups_single_events-container, #bookacti-groups_first_event_only-container").hide():
$j("#bookacti-groups_only-container, #bookacti-groups_single_events-container, #bookacti-groups_first_event_only-container").show()}),$j("#bookacti-form-field-dialog-calendar").on("change","input#bookacti-bookings_only",function(){$j(this).is(":checked")?($j("#bookacti-status-container, #bookacti-user_id-container, #bookacti-booked-events-fieldset").show(),$j("#bookacti-hide_availability-container").hide()):($j("#bookacti-status-container, #bookacti-user_id-container").hide(),$j("#bookacti-hide_availability-container").show())}),
$j("#bookacti-form-field-dialog-calendar").on("change","select#bookacti-form_action",function(){$j(".bookacti-activities-actions-options-table, .bookacti-group-categories-actions-options-table").show();$j(this).val()==="default"?$j(".bookacti-activities-actions-options-table, .bookacti-group-categories-actions-options-table").hide():$j(this).val()==="redirect_to_url"&&$j(".bookacti-activities-actions-options-table .bookacti-column-redirect_url, .bookacti-group-categories-actions-options-table .bookacti-column-redirect_url").show();
$j("select#bookacti-group_categories").val()==="none"&&$j(".bookacti-group-categories-actions-options-table").hide()}),$j("#bookacti-form-field-dialog-calendar").on("change","select#bookacti-form_action",function(){$j(".bookacti-activities-actions-options-table .bookacti-column-product, .bookacti-group-categories-actions-options-table .bookacti-column-product").hide();if($j(this).val()==="redirect_to_product_page"||$j(this).val()==="add_product_to_cart")$j(".bookacti-activities-actions-options-table .bookacti-column-redirect_url, .bookacti-group-categories-actions-options-table .bookacti-column-redirect_url").hide(),
$j(".bookacti-activities-actions-options-table .bookacti-column-product, .bookacti-group-categories-actions-options-table .bookacti-column-product").show();$j("select#bookacti-group_categories").val()==="none"&&$j(".bookacti-group-categories-actions-options-table").hide()}),$j("#bookacti-form-field-dialog-calendar").on("change","#bookacti-availability_period_start-container .bookacti-duration-value, #bookacti-availability_period_end-container .bookacti-duration-value, #bookacti-start, #bookacti-end, #bookacti-out_of_period_events, #bookacti-past_events, #bookacti-past_events_bookable",
...
b=moment.utc(b),a.isAfter(b)&&$j(this).parent().append("<div class='bookacti-form-error'>"+bookacti_localized.error_closing_before_opening+"</div>"))}),$j("#bookacti-form-editor").on("bookacti_field_updated bookacti_field_reset",function(a,b,c,d){c==="calendar"?(a=$j("#bookacti-form-editor-field-"+b+" .bookacti-booking-system"),b=a.attr("id"),a.empty(),bookacti_clear_booking_system_displayed_info(a),bookacti.booking_system[b]=d.booking_system_attributes?d.booking_system_attributes:[],bookacti_reload_booking_system(a)):
c==="login"&&(d=$j("#bookacti-form-editor .bookacti-form-field-container.bookacti-form-field-type-login"),bookacti_show_hide_register_fields(d))}),$j(window).on("beforeunload",function(a){if($j("#major-publishing-actions").data("popup"))return!0}),window.onerror=function(a,b,c,d,e){$j("#bookacti-fatal-error").show()})});
...
if(d.status==="success")$j("body").trigger("bookacti_form_updated"),b==0?($j("#major-publishing-actions").data("popup",0),window.location.replace(a.attr("action")+"&notice=published")):$j("#bookacti-form-editor-page-container").before('<div class="notice notice-success is-dismissible bookacti-form-notice" ><p>'+d.message+"</p></div>");else if(d.status==="failed"){var e=typeof d.message!=="undefined"?d.message:bookacti_localized.error;$j("#bookacti-form-editor-page-container").before('<div class="notice notice-error is-dismissible bookacti-form-notice" ><p>'+
...
function bookacti_save_form_field_order(){var a=$j("#bookacti-form-id").val();if($j.isNumeric(a)){var b=[];$j(".bookacti-form-editor-field").each(function(){b.push($j(this).data("field-id"))});b.length&&(a={action:"bookactiSaveFormFieldOrder",form_id:a,field_order:b,nonce:$j('#bookacti-form-editor-page-form input[name="nonce"]').val()},bookacti_form_editor_enter_loading_state(),$j.ajax({url:ajaxurl,data:a,type:"POST",dataType:"json",success:function(c){c.status==="success"?(bookacti.form_editor.form.field_order=
c.field_order,$j("#bookacti-form-editor").trigger("bookacti_form_field_order_updated")):c.status==="failed"&&(console.log(typeof c.message!=="undefined"?c.message:bookacti_localized.error),console.log(c))},error:function(c){console.log("AJAX "+bookacti_localized.error);console.log(c)},complete:function(){bookacti_form_editor_exit_loading_state()}}))}}
...
function bookacti_refresh_redirect_url_by_activity_table(){var a=$j("select#bookacti-activities").val();a==="all"&&(a=[],$j("select#bookacti-activities").find("option:not(:disabled)").each(function(){var c=$j(this).attr("value");$j.isNumeric(c)&&a.push(c)}));if(a&&($j.isArray(a)||$j.isNumeric(a))){$j.isArray(a)||(a=[a]);var b=$j(".bookacti-activities-actions-options-table tbody");$j.each(a,function(c,d){c=$j("option#bookacti-activities_"+d).text();if(b.find('.bookacti-column-redirect_url input[name="redirect_url_by_activity['+
...
$j(this).removeClass("select2-hidden-accessible")});b.find("tr:last td.bookacti-column-activity").text(c).attr("title",c);b.find("tr:last :input").val("").prop("disabled",!1);b.find("tr:last").closest("tr").data("activity_id",d);b.find("tr:last").closest("tr").attr("data-activity_id",d);bookacti_select2_init();b.find("tr:last").show()});b.find("tr").each(function(){var c=$j(this);if(!c.data("activity_id"))return $j(this).remove(),!0;var d=c.data("activity_id");$j.inArray(d,a)===-1&&(c.find(":input").prop("disabled",
!0),c.hide())})}}
function bookacti_refresh_redirect_url_by_group_category_table(){var a=$j("#bookacti-group_categories").val(),b=$j(".bookacti-group-categories-actions-options-table").is(":visible");a==="none"&&($j(".bookacti-group-categories-actions-options-table").hide(),$j(".bookacti-group-categories-actions-options-table :input").prop("disabled",!0));a==="all"&&(a=[],$j("#bookacti-group_categories").find("option:not(:disabled)").each(function(){var d=$j(this).attr("value");$j.isNumeric(d)&&a.push(d)}));if(a&&
($j.isArray(a)||$j.isNumeric(a))){$j.isArray(a)||(a=[a]);b||$j("select#bookacti-form_action").val()==="default"||$j(".bookacti-group-categories-actions-options-table").show();$j(".bookacti-group-categories-actions-options-table :input").prop("disabled",!1);var c=$j(".bookacti-group-categories-actions-options-table tbody");$j.each(a,function(d,e){d=$j("option#bookacti-group_categories_"+e).text();if(c.find('.bookacti-column-redirect_url input[name="redirect_url_by_group_category['+e+']"]').length){var f=
...
c.find("tr:last td.bookacti-column-group_category").text(d).attr("title",d);c.find("tr:last :input").val("").prop("disabled",!1);c.find("tr:last").closest("tr").data("category_id",e);c.find("tr:last").closest("tr").attr("data-category_id",e);bookacti_select2_init();c.find("tr:last").show()});c.find("tr").each(function(){var d=$j(this);if(!d.data("category_id"))return $j(this).remove(),!0;var e=d.data("category_id");$j.inArray(e,a)===-1&&(d.find(":input").prop("disabled",!0),d.hide())})}}
function bookacti_toggle_form_calendar_settings_availability_fields(){var a=$j("#bookacti-form-field-dialog-calendar #bookacti-start"),b=$j("#bookacti-form-field-dialog-calendar #bookacti-end"),c=$j("#bookacti-form-field-dialog-calendar #bookacti-availability_period_start-container .bookacti-duration-value"),d=$j("#bookacti-form-field-dialog-calendar #bookacti-availability_period_end-container .bookacti-duration-value"),e=$j("#bookacti-form-field-dialog-calendar #bookacti-out_of_period_events"),f=
$j("#bookacti-form-field-dialog-calendar #bookacti-past_events"),g=$j("#bookacti-form-field-dialog-calendar #bookacti-past_events_bookable");a=a.val()!=="";b=b.val()!=="";c=parseInt(c.val())!==0&&c.val()!=="";d=parseInt(d.val())!==0&&d.val()!=="";var h=e.is(":checked"),k=f.is(":checked");e.closest(".bookacti-field-container").toggle(c||d||a||b);f.closest(".bookacti-field-container").toggle(!c||h);g.closest(".bookacti-field-container").toggle(k)};
