...
"group":"event";bookacti_validate_event_repetition_data(a)});$j("#bookacti-template-data-dialog").on("bookacti_default_template_settings",function(){bookacti_delete_days_off_rows($j("#bookacti-template-data-dialog .bookacti-date-intervals-table-container"));$j("#bookacti-template-data-dialog input.bookacti-days-off-from, #bookacti-template-data-dialog input.bookacti-days-off-to").attr("min","").attr("max","");var a=bookacti.booking_system["bookacti-template-calendar"].template_data;typeof a.settings!==
"undefined"&&typeof a.settings.days_off!=="undefined"&&($j.isEmptyObject(a.settings.days_off)||bookacti_fill_days_off($j("#bookacti-template-data-dialog .bookacti-date-intervals-table-container"),a.settings.days_off))});$j("#bookacti-activity-data-dialog").on("change","#bookacti-display-activity-user-roles",function(){$j("#bookacti-activity-roles-container").toggle($j(this).prop("checked"))});$j("#bookacti-group-category-dialog").on("change","#bookacti-display-group-category-user-roles",function(){$j("#bookacti-group-category-roles-container").toggle($j(this).prop("checked"))});
$j("#bookacti-activity-data-dialog").on("bookacti_activity_insert_dialog bookacti_activity_update_dialog",function(){$j("#bookacti-display-activity-user-roles").prop("checked",$j("#bookacti-activity-roles option:selected").length).trigger("change")});$j("#bookacti-group-category-dialog").on("bookacti_group_category_update_dialog",function(){$j("#bookacti-display-group-category-user-roles").prop("checked",$j("#bookacti-group-category-roles option:selected").length).trigger("change")});$j("body").on("bookacti_empty_all_dialogs_forms",
function(a,e){$j(e+" #bookacti-display-activity-user-roles, "+e+" #bookacti-display-group-category-user-roles").prop("checked",!1).trigger("change")});$j("#bookacti-activity-reschedule-scope").on("change",function(){var a=$j(this).val()||"";$j("#bookacti-activity-reschedule-activity-ids-container").toggle(a.indexOf("custom")>-1)})});
function bookacti_validate_template_form(){var a=$j("#bookacti-template-title").val(),e=$j("#bookacti-template-duplicated-template-id").val(),f=$j("#bookacti-snapduration").val(),b={isTitle:!1,isSnapFreqFormatted:!1,isDuplicateIdPositive:!0,send:!1};a!==""&&(b.isTitle=!0);$j.isNumeric(e)&&parseInt(e)<0&&(b.isDuplicateIdPositive=!1);/^([0-1][0-9]|2[0-3]):([0-5][0-9])$/.test(f)&&(b.isSnapFreqFormatted=!0);b.isTitle&&b.isDuplicateIdPositive&&b.isSnapFreqFormatted&&(b.send=!0);$j("#bookacti-template-data-dialog .bookacti-form-error, #bookacti-template-data-dialog .bookacti-notices").remove();
...
!0);e.length&&(c.isColor=!0);f.length&&(c.isAvail=!0);c.isAvail&&parseInt(f)>=0&&(c.isAvailPositive=!0);b.length&&(c.isDays=!0);g.length&&(c.isHours=!0);d.length&&(c.isMinutes=!0);c.isDays&&b<=365&&b>=0&&(c.isDaysInfTo365=!0);c.isHours&&g<=23&&g>=0&&(c.isHoursInfTo23=!0);c.isMinutes&&d<=59&&d>=0&&(c.isMinutesInfTo59=!0);if(b>0||g>0||d>0)c.isSupToZero=!0;c.isTitle&&c.isColor&&c.isAvailPositive&&c.isDaysInfTo365&&c.isHoursInfTo23&&c.isMinutesInfTo59&&c.isSupToZero&&(c.send=!0);$j("#bookacti-activity-data-dialog .bookacti-form-error, #bookacti-activity-data-dialog .bookacti-notices").remove();
...
function bookacti_validate_event_general_data(){var a=$j("#bookacti-event-data-dialog #bookacti-event-title").val(),e=parseInt($j("#bookacti-event-data-dialog #bookacti-event-availability").val()),f={isTitle:!1,isAvailPositive:!1,send:!1};a!==""&&(f.isTitle=!0);e>=0&&(f.isAvailPositive=!0);f.isTitle&&f.isAvailPositive&&(f.send=!0);$j("#bookacti-event-title-container .bookacti-form-error, #bookacti-event-availability-container .bookacti-form-error, #bookacti-event-data-dialog .bookacti-form-field-error").remove();
...
function bookacti_validate_event_repetition_data(a){if(a==="group"||a==="event")if(a!=="group"||typeof bookacti.booking_system["bookacti-template-calendar"].selected_events[0]!=="undefined")if(a!=="event"||typeof bookacti.booking_system["bookacti-template-calendar"].picked_events[0]!=="undefined"){var e=moment.utc((a==="group"?bookacti.booking_system["bookacti-template-calendar"].selected_events[0]:bookacti.booking_system["bookacti-template-calendar"].picked_events[0]).start).clone().locale("en");
a=a==="group"?"#bookacti-group-of-events-dialog":"#bookacti-event-data-dialog";var f=$j(a+' select[name="repeat_freq"]').val()?$j(a+' select[name="repeat_freq"]').val():"none",b=moment.utc($j(a+' input[name="repeat_from"]').val()).locale("en"),g=moment.utc($j(a+' input[name="repeat_to"]').val()).locale("en"),d={isRepeated:!1,isRepeatFrom:!1,isRepeatTo:!1,isFromBeforeTo:!1,isEventBetweenFromAndTo:!1,send:!1};f!=="none"&&(d.isRepeated=!0);isNaN(b)||b===""||b===null||(d.isRepeatFrom=!0);isNaN(g)||g===
""||g===null||(d.isRepeatTo=!0);d.isRepeatFrom&&d.isRepeatTo&&b<g&&(d.isFromBeforeTo=!0);d.isRepeated&&b.isSameOrBefore(e,"day")&&g.isSameOrAfter(e,"day")&&(d.isEventBetweenFromAndTo=!0);if(!d.isRepeated||d.isRepeated&&d.isRepeatFrom&&d.isRepeatTo&&d.isFromBeforeTo&&d.isEventBetweenFromAndTo)d.send=!0;d.isRepeated||($j(a+' input[name="repeat_from"]').prop("disabled",!0),$j(a+' input[name="repeat_to"]').prop("disabled",!0));$j(a+' div[id$="-repeat-days-container"]').hide();$j(a+' div[id$="-repeat-monthly_type-container"]').hide();
...
[d]);d.isRepeated&&($j(a+' input[name="repeat_from"]').prop("disabled",!1),$j(a+' input[name="repeat_to"]').prop("disabled",!1),$j(a+' div[id$="-repeat-from-container"]').show(),$j(a+' div[id$="-repeat-to-container"]').show(),$j("#bookacti-group-of-events-repetition-first-event-notice").show(),f==="weekly"?$j(a+' div[id$="-repeat-days-container"]').show():f==="monthly"&&$j(a+' div[id$="-repeat-monthly_type-container"]').show(),d.isFromBeforeTo&&d.isEventBetweenFromAndTo?$j(a+' div[id$="-repeat-exceptions-container"]').show():
($j(a+' input[name="repeat_from"], '+a+' input[name="repeat_to"]').addClass("bookacti-input-error"),d.isFromBeforeTo?d.isEventBetweenFromAndTo||$j(a+" .bookacti-error-list").append('<li class="bookacti-repeat-error">'+bookacti_localized.error_event_not_btw_from_and_to+"</li>"):$j(a+" .bookacti-error-list").append('<li class="bookacti-repeat-error">'+bookacti_localized.error_repeat_end_before_begin+"</li>")));$j(a+" .bookacti-notices").toggle($j(a+" .bookacti-notices li").length>0);return d.send}}
...
function bookacti_validate_group_of_events_general_data(){var a=$j("#bookacti-group-of-events-title-field").val(),e=$j("#bookacti-group-of-events-category-selectbox").val(),f=$j("#bookacti-group-of-events-category-title-field").val(),b={isTitle:!1,isCategory:!1,isCategoryTitle:!1,isSelectedEvents:!1,send:!1};typeof a==="string"&&a!==""&&(b.isTitle=!0);typeof e==="string"&&e!=="new"&&(b.isCategory=!0);typeof f==="string"&&f!==""&&(b.isCategoryTitle=!0);bookacti.booking_system["bookacti-template-calendar"].selected_events.length>=
2&&(b.isSelectedEvents=!0);b.isTitle&&(b.isCategory||b.isCategoryTitle)&&b.isSelectedEvents&&(b.send=!0);$j("#bookacti-group-of-events-dialog .bookacti-form-error, #bookacti-group-of-events-dialog .bookacti-form-field-error").remove();$j("#bookacti-group-of-events-dialog input, #bookacti-group-of-events-dialog select").removeClass("bookacti-input-error");b.send||($j("#bookacti-group-of-events-dialog .bookacti-error-list").length||$j("#bookacti-group-of-events-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"></ul></div>'),
...
function bookacti_validate_group_category_form(){var a=$j("#bookacti-group-category-title-field").val(),e={isTitle:!1,send:!1};typeof a==="string"&&a!==""&&(e.isTitle=!0);e.isTitle&&(e.send=!0);$j("#bookacti-group-category-dialog .bookacti-form-error, #bookacti-group-category-dialog .bookacti-notices").remove();$j("#bookacti-group-category-dialog input, #bookacti-template-data-dialog select").removeClass("bookacti-input-error");e.send||($j("#bookacti-group-category-dialog").append('<div class="bookacti-notices"><ul><li>'+
