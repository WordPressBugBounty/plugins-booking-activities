...
function bookacti_generate_export_bookings_url(b){b=b||!1;$j("#bookacti-export-bookings-dialog .bookacti-notices").remove();bookacti_add_loading_html($j("#bookacti-export-bookings-dialog"));var a=bookacti_serialize_object($j("#bookacti-export-bookings-form"));a.action="bookactiExportBookingsUrl";a.reset_key=b?1:0;a.booking_filters=bookacti_get_booking_list_filters();$j("body").trigger("bookacti_export_bookings_url_data",[a,b]);$j.ajax({url:ajaxurl,type:"POST",data:a,dataType:"json",success:function(e){if(e.status===
"success")$j("#bookacti_export_bookings_url_secret").val(e.url),$j("#bookacti-export-bookings-dialog").append('<div class="bookacti-notices"><ul class="bookacti-success-list"><li>'+e.message+"</li></ul></div>").show(),$j("#bookacti-export-bookings-url-container").data("export-type",a?.export_type),$j("#bookacti-export-bookings-url-container").show(),$j("body").trigger("bookacti_export_bookings_url",[e]);else if(e.status==="failed"){var c=typeof e.message!=="undefined"?e.message:bookacti_localized.error;
