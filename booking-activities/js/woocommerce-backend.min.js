...
function bookacti_show_hide_empty_price_notice(a){a=parseInt(a)||"product";$j("#woocommerce-product-data .bookacti-empty-product-price-notice").remove();var c='<div class="bookacti-empty-product-price-notice bookacti-warning"><span class="dashicons dashicons-warning"></span>'+bookacti_localized.empty_product_price+"</div>",b=",";"undefined"!==typeof woocommerce_admin&&"undefined"!==typeof woocommerce_admin.mon_decimal_point&&(b=woocommerce_admin.mon_decimal_point);"product"===a?(b=$j("#_regular_price").length?
$j("#_regular_price").val().replace(b,"."):"",a=$j.isNumeric(b)?parseFloat(b):"",!a&&0!==a&&"0"!==a&&$j("#_bookacti_is_activity").is(":checked")&&$j("#_regular_price, #_bookacti_form").after(c)):a&&(--a,b=$j('input[name="variable_regular_price['+a+']"]').length?$j('input[name="variable_regular_price['+a+']"]').val().replace(b,"."):"",b=$j.isNumeric(b)?parseFloat(b):"",!b&&0!==b&&"0"!==b&&$j("#bookacti_variable_is_activity_"+a).is(":checked")&&$j('input[name="variable_regular_price['+a+']"], #bookacti_variable_form_'+
a).after(c))}
